...
<head>
    ...
    <title>Status Base Salary {{ $monthName }},{{$salaryYear}}
    ...
    <div class="main__wrap">
        ...
        <section class="table__part">
            <table>
                <thead>
                    <tr>
                        <th colspan ="11" >{{ $monthName }}, {{$salaryYear}}, {{ $project->proj_name}} </th>                        
                    </tr>
                    <tr>
                        <th>SL<br>No </th>
                ...
                <tbody>
                    ...
                    <tr style="border-bottom:0;">
                        ...
                        <td class="td__total">Total Salary <br> {{ $total_slh_all_include_amount }}  </td>
