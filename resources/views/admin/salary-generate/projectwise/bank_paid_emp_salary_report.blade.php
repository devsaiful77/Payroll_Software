    ...
    <div class="main__wrap">
        ...
        <section class="header__part">
            ...
            <div class="date__part">
                <p><strong> {{ $report_left_title[0] }} <br> Month of {{ $report_left_title[1] }} {{ $report_left_title[2] }} </strong> </p>                 
            </div>
            <!-- title -->
        ...
        <section class="table__part">
            <table>
                <thead>
                    <tr>
                        <th colspan ="11" class="td__header_title" >{{ $report_left_title[1] }}, {{$report_left_title[2]}} </th>                        
                    </tr>
                    <tr>
                        <th>SL<br>No </th>
                ...
                <tbody>
                    ...
                    <tr style="border-bottom:0;">
                        ...
                        <td class="td__center"> <span class="employe__trade"> {{ Str::limit($salary->catg_name,10) }}</span> <br><br> {{round($salary->food_allowance) }}
                                + {{$salary->slh_bonus_amount}} + {{$salary->mobile_allowance +$salary->medical_allowance +$salary->local_travel_allowance +$salary->conveyance_allowance + $salary->others }} </td>
                    ...
                    <tr style="border-bottom:0;">
                        ...
                        <td class="td__total">S.T+Adv<br>{{ $totalSaudiTax }}<br> {{ $totalOtherAdvance }}
