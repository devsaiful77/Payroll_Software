            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr style="border-bottom:0;">
                        ...
                        {{round( $salary->slh_all_include_amount) }}
...
-                    
                    ...
                    <tr style="border-bottom:0;">
                        ...
                        <td class="td__total">Total Salary <br> {{ $total_slh_all_include_amount }}
                        <!--{{ $totalSalaryAmount + $totalSaudiTax + $totalIqamaRenewal +$totalOtherAdvance +$totalContribution }}-->
                        </td>
                        ...
                        <td class="td__total"> Salary <br> {{round( $totalSalaryAmount) }} </td>
