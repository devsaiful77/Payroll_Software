  ...
  <section class="salary">
      <div class="container">
        ...
        <div class="salary__header-bottom">
            <div class="row">
                <div class="col-md-3">
                    <p class="toEndDate"> <strong>Report Generate: </strong> <span>{{ $toMonth }} To {{ $endMonth }}</span> </p>
              ...
              <div class="row">
                  <div class="col-md-12">
                      <table class="table table-responsive salary__table">
                          ...
                          <tbody>
                            @foreach($projectWiseTotalWork as $data)
                            <tr class="salary-row-parent">
                              ...
                              <td> <span>{{ $data->total_hours }}</span> </td>
                              <td> <span>{{ $data->overtime }}</span> </td>
                              <td> <span>{{ $data->overtime + $data->total_hours}}</span> </td>
                              <td> <span>{{ $data->total_work_day }}</span> </td>
                            </tr>
                            @endforeach
                            <!-- total hours -->
                            <tr>
                              <td colspan="8"> <span style="display:block; text-align:right">Total Work Hours</span> </td>
                              <td> <span>{{ $totalWorkHours }}</span> </td>
                              <td></td>
                            </tr>
                          </tbody>
                      </table>
