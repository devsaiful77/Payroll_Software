...
@section('title') Project Basic Total Salary @endsection
@section('content')

<div class="row bread_part">
    <div class="col-sm-12 bread_col">
        <h4 class="pull-left page-title bread_title"> Project Basic Total Salary </h4>
        <ol class="breadcrumb pull-right">
            <li><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
            <li class="active"> Project Salary Report</li>
        </ol>
    </div>
</div>
...
<div class="row">
    <div class="col-md-2"></div>
    <div class="col-lg-8">
        <form class="form-horizontal" id="registration" target="_blank" method="post" action="{{ route('project-wise-total-salary.generat') }}">
          @csrf
          <div class="card">
