...
@section('title') Metarial & Tools Item Details @endsection
@section('content')
<div class="row bread_part">
    <div class="col-sm-12 bread_col">
        <h4 class="pull-left page-title bread_title">Inventory New Item Edit</h4>
        <ol class="breadcrumb pull-right">
            <li><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
            <li class="active"> Inventory Item Edit</li>
        </ol>
    </div>
</div>
<!-- add division -->
...
<div class="row">
    ...
    <div class="col-md-6">
      <form class="form-horizontal" id="registration" action="{{ route('update.item-type-item-name') }}" method="post">
        @csrf
        <div class="card">
            ...
            <div class="card-body card_form" style="padding-top: 0;">
                ...
                <input type="hidden" name="item_deta_code" value="{{ $edit->item_deta_code }}">
              ...
              <div class="form-group custom_form_group{{ $errors->has('itype_id') ? ' has-error' : '' }}">
                  ...
                  <div>
                    <select class="form-control" name="itype_id">
              ...
              <div class="form-group custom_form_group{{ $errors->has('iscatg_id') ? ' has-error' : '' }}">
                  ...
                  <div>
                    <select class="form-control" name="iscatg_id">
                        <option value="{{ $edit->itemSubCatg->iscatg_id }}">{{ $edit->itemSubCatg->iscatg_name }}</option>
                    </select>
              ...
              <div class="form-group custom_form_group{{ $errors->has('item_deta_name') ? ' has-error' : '' }}">
                  <label class="control-label d-block" style="text-align: left;">Item Details Name:<span class="req_star">*</span></label>
                  <div>
                    <input type="text" class="form-control" name="item_deta_name" value="{{ $edit->item_deta_name }}" placeholder="Item Details Name">
