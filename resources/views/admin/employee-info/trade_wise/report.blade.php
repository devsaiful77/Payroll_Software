              ...
              <div class="row">
                  <div class="col-md-3">
                    <div class="project_info" style="margin-left:0">
                      ...
                      <span class="project_name">  <strong>Employee Type :</strong> {{ $empTypeName }} </span>
                     <br><span class="project_name">  <strong>Trade :</strong> {{ $tradeName }} </span>
                    </div>
                  </div>
                      ...
                      <table class="table table-responsive salary__table">
                          ...
                          <tbody>
                            @foreach ($employee as $emp)
                              <tr class="salary-row-parent" style =" height:30px">
                                  ...
                                  <td> <span>{{ $emp->hourly_employee == 1 ? "Hourly":"Basic Salary" }}</span> </td>
