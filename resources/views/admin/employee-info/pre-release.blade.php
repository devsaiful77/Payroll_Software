...
@section('title') Pre Release Employee list @endsection
@section('content')

<div class="row bread_part">
    <div class="col-sm-12 bread_col">
        <h4 class="pull-left page-title bread_title">Pre Release Employee List</h4>
        <ol class="breadcrumb pull-right">
            <li><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
            <li class="active">Pre Release Employee List</li>
        </ol>
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-md-7">
        ...
        <div class="alert alert-success alertsuccess" role="alert">
            <strong>Successfully!</strong> Update employee status.
        </div>
        @endif
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-8">
                        <h3 class="card-title card_top_title"><i class="fab fa-gg-circle"></i> Pre Release Employee List </h3>
                    </div>
                                    ...
                                    @foreach($all as $item)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{route('pre.releaseListemployee-status',$item->emp_auto_id) }}" title="Release">Release</a>
