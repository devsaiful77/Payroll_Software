    ...
    <div class="main__wrap">
        ...
        <section class="header__part">
            ...
            <div class="title_left__part">
                <p> <strong>Employee Working Records <br>
        ...
        <section class="table__part">
            <table>
                ...
                <tbody>
                    @php $total_basic_hours =0; $total_ot = 0; @endphp
                    @foreach ($work_records as $emp)
                    @php 
                        $total_basic_hours += $emp->total_hour ; 
                        $total_ot += $emp->total_overtime;
                    @endphp
                    <tr >
                        ...
                        <td class="td__total"> {{ $emp->total_hour }}</td>
                        <td class="td__total"> {{ $emp->total_overtime }}</td>   
                        <td class="td__total"> {{ $emp->total_overtime + $emp->total_hour }}</td>   
                        <td class="td__total"> {{ $emp->total_day }}</td>                                          
                       </tr>
                    @endforeach
                    <tr>
                        <td class="td__grand_total" colspan="8">Total </td>
                                             
                        <td class="td__grand_total"> {{ $total_basic_hours }}</td>
                        <td class="td__grand_total"> {{ $total_ot }}</td>   
                        <td class="td__grand_total"> {{ $total_ot + $total_basic_hours }}</td>   
                        <td class="td__grand_total">   </td>     
                    </tr>
                </tbody>
