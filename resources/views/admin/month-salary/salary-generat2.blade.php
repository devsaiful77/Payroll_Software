                        ...
                        <table class="table table-responsive salary__table">
                            ...
                            <tbody>
                              <tr>
                                ...
                                <tr class="first-row">
                                    <td>1</td>
                                    <td><span style="color: #2F72BC; font-weight: bold;"> EMP_102</span></td>
                                    <td class="name_data">Saiful islam</td>
                                    <td></td>
                                    <td></td>
                                ...
                                <tr class="second-row">
                                    ...
                                    <td></td>
                                    <td></td>
                                    <td style="color: #22B68F; font-size: 13px; font-weight: 900; text-transform: uppercase;">13</td>
                                    <td>190 <br> 0</td>
                                    <td>2,470</td>
                                    <td>0 <br> 0</td>
                                    <td>0</td>
                                    ...
                                    <td>0</td>
                                    <td>2,270.00</td>
                                    <td class="signature_data"> <span>Shapoorji Pallonji - SABIC - JUBAIL</span></td>
                                </tr>
                                <!-- third tr -->
                                <tr class="third-row">
                                    <td></td>
                                    ...
                                    <td></td>
                                    <td></td>
                                    <td class="total_amount"><span>2,270.00</span></td>
                                    <td></td>
                                </tr>
                              </tr>
                              <!-- second row -->
                              <tr>
                                ...
                                <tr class="third-row">
                                    ...
                                    <td></td>
                                    <td></td>
                                    <td class="total_amount"><span style="padding-top: 3px;">2,270.00</span></td>
                                    <td></td>
                                </tr>
                              </tr>
