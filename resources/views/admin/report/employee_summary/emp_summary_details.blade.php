...
<body>
    ...
    <div class="main__wrap">
        ...
        <section class="table__part">
            <table id="employeeinfo">
                <thead>
                     <tr> <td colspan="12" style="text-align:center; font-size:14px; "> Salary Details of {{ $employee->employee_id}}, {{$employee->employee_name}} </td></tr>
                    <tr>
                        <th>SL No </th>
                        <th> Month </th>
                        <th> BS/Rate </th>
        ...
        <section>
            ...
            <tbody>
                    ...
                    <tr>
                        ...
                        <td class="td__gross_salary">IQAMA & OTHER EXPENSES UNPAID:</td>
