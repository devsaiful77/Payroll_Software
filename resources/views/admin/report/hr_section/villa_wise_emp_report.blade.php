        ...
        <section class="table__part">
            <table>
                ...
                <tr >
                  ...
                  <td class="td__emplyoee_info"> {{$emp->akama_expire_date }}</td>
                  <td class="td__iqama"> {{  Str::length($emp->mobile_no) == 10 ? $emp->mobile_no : "" }}, {{  Str::length($emp->phone_no) < 10 ? "" : $emp->phone_no }} </td>
                  ...
                  <td class="td__iqama"> {{ $emp->ofb_name }} </td>
                 </tr>
                @endforeach
              </tbody>
