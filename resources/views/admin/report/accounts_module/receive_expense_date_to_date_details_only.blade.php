...
<head>
    ...
    <title>Receive&Expense Details</title>
    <style> 
...
<body>
    ...
    <div class="main__wrap">
        ...
        <br>
        <h4 style="text-align: center;padding-bottom:10px"> Cash Receive and Expense Details From {{$from_date}} To  {{$to_date}}</h4>
        <!-- Credit/Cash Invoice Record -->
        ...
        <section class="table__part">
            <table id="employeeinfo">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="8" class="td__gross_salary"> Balance (Cash Receive - Expense) </td>
                        <td class="td__gross_salary"> {{ number_format($total_cr_amount - $total_expense_amount,2)}} </td>    
                    </tr>
