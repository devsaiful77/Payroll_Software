    ...
    <div class="main__wrap">
        ...
        <section class="header__part">
            ...
            <div class="title_left__part">
                ...
                <p> <strong> Advance Summary <br/> <span class="startDate">{{Carbon\Carbon::parse($start_date)->format('d F Y')}}</span> To <span class="endDate"> {{ Carbon\Carbon::parse($end_date)->format('d F Y')}} </span></strong></p>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="td__emplyoee_name"> <span>{{ $emp->advPurpose->purpose }}</span> </td>
                        <td class="td__emplyoee_name"> <span>{{ $emp->user->name }}</span> </td>
                        <td class="td__date"> <span>{{ $emp->date }}, {{ $emp->year }}</span> </td>
                    ...
                    <tr>
                        ...
                        <td colspan="8"></td>
                        <td class="td__emplyoee_name">Total :</td>
                        <td class="td__amount"> {{ $totalAdvanceAmount }}</td>
                    </tr>
                </tbody>
            </table>
        </section>
