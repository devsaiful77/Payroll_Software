...
<body>
    <div class="main__wrap">
        ...
        <h4 style="text-align:center"> {{$month_name}}, {{$year}} Advance Unpaid Employees</h4><br>
         <!-- table part -->
         <section class="table__part">
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="td__s_n" colspan="7"> <span> Total </span> </td>
                        
                        <td class="td__total_amount"> <span>{{ $total_amount }}</span> </td>
                    </tr>
