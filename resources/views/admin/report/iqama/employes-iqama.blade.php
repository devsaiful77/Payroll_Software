      ...
      <form class="form-horizontal" id="registration" target="_blank" action="{{ route('singleEmpl-iqwama-renewal-process') }}" method="post">
        ...
        <div class="card">
            <div class="card-body card_form">
              ...
              <div class="form-group row custom_form_group{{ $errors->has('Project') ? ' has-error' : '' }}">
                  <label class="col-md-3 control-label d-block">Project ID:<span class="req_star">*</span></label>
                  <div class="col-md-7">
                    <input type="text" class="form-control typeahead" placeholder="Type Employee ID" name="Project" id="Project_search" onkeyup="empSearch()" onfocus="showResult()" onblur="hideResult()" value="{{ old('Project') }}">
