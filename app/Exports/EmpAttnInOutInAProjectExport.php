...
class EmpAttnInOutInAProjectExport implements FromCollection, WithHeadings, WithMapping,ShouldAutoSize, WithStyles, WithEvents
{
    ...
    {      
        ...
        $excell_header[$i+7] = "Absent";
        $excell_header[$i+8] = "Basic Hours";
        $excell_header[$i+9] = "Overtime";
        $excell_header[$i+10] = "Days";
    ...
    {        
        ...
        $records[$this->numberOfDaysInThisMonth+7] = $this->numberOfDaysInThisMonth - $attendence->count(); 
        $records[$this->numberOfDaysInThisMonth+8] = $total_work_hours; 
        $records[$this->numberOfDaysInThisMonth+9] =   $total_overtime; 
